				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<div class="tg-logobox">
							<strong class="tg-logo"><a href="index-2.html"><img src="images/logo3.png" alt="University of Education and knowledge"></a></strong>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="tg-comingsoon">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="tg-description">
								<p>Consectetur adipisicing elit sed do eiusmod tempor incididunt labore dolore msagna aliqua enim ad minim veniam quis nostrud exercitation ullaasmco laboris nisi uiat aliquip.</p>
							</div>
						</div>
