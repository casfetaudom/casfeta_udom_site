										...
										<li class="menu-item-has-mega-menu current-menu-item">
											...
											<div class="mega-menu">
												<ul class="mega-menu-row">
													...
													<li class="mega-menu-col current-menu-item">
														<a href="javascript:void(0);">Faculties</a>
														<ul>
															<li class="current-menu-item"><a href="faculties.html">faculties</a></li>
									...
									<div id="tg-facultiescollapse" class="tg-themecollapse tg-facultiescollapse">
										...
										<div class="tg-themecollapsecontent">
											<div class="row">
												...
												<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
													<div class="tg-faculty">
														<figure><a href="javascript:void(0);"><img src="images/speakers/img-05.jpg" alt="image description"></a></figure>
														<div class="tg-facultyname">
															<h3><a href="javascript:void(0);">Maragaret Ellinger</a></h3>
														</div>
														<span class="tg-facultydesignation">Professor</span>
												...
												<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
													<div class="tg-faculty">
														<figure><a href="javascript:void(0);"><img src="images/speakers/img-06.jpg" alt="image description"></a></figure>
														<div class="tg-facultyname">
															<h3><a href="javascript:void(0);">Alphonse Travis</a></h3>
														</div>
														<span class="tg-facultydesignation">Assistant Professor</span>
												...
												<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
													<div class="tg-faculty">
														<figure><a href="javascript:void(0);"><img src="images/speakers/img-07.jpg" alt="image description"></a></figure>
														<div class="tg-facultyname">
															<h3><a href="javascript:void(0);">Bernardina Verde</a></h3>
														</div>
														<span class="tg-facultydesignation">Lecturer</span>
										...
										<h3 class="fa fa-angle-down">Faculty of Languages &amp; Literature</h3>
										<div class="tg-themecollapsecontent">
											<div class="row">
												<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
													<div class="tg-faculty">
										...
										<h3 class="fa fa-angle-down">Faculty of Medicine &amp; Dentistry</h3>
										<div class="tg-themecollapsecontent">
											<div class="row">
												<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
													<div class="tg-faculty">
										...
										<h3 class="fa fa-angle-down">Faculty of Management Sciences</h3>
										<div class="tg-themecollapsecontent">
											<div class="row">
												<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
													<div class="tg-faculty">
										...
										<h3 class="fa fa-angle-down">Faculty of Pharmacy</h3>
										<div class="tg-themecollapsecontent">
											<div class="row">
												<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
													<div class="tg-faculty">
										...
										<h3 class="fa fa-angle-down">Faculty of Sciences</h3>
										<div class="tg-themecollapsecontent">
											<div class="row">
												<div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
													<div class="tg-faculty">
