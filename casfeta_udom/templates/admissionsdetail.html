									...
									<ul>
										...
										<li class="menu-item-has-children current-menu-item">
											...
											<ul class="sub-menu">
												...
												<li class="current-menu-item"><a href="admissionsdetail.html">Admission Detail</a></li>
											</ul>
										</li>
										<li class="menu-item-has-children">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<ol class="tg-breadcrumb">
							...
							<li class="tg-active">addmission detail</li>
						</ol>
					</div>
				</div>
			</div>
						...
						<div class="col-xs-12 col-sm-8 col-md-9 col-lg-9 pull-right">
							<div id="tg-content" class="tg-content">
								<div class="tg-addmission tg-addmissiondetail">
									<span class="tg-lastmodified">Admission Criteria</span>
									<div class="tg-pagetitle">
										<h2>Diploma in Medical Radiology &amp; Diagnostic (DMRD)</h2>
									</div>
											...
											<div class="tg-themecollapsecontent">
												<ul>
													...
													<li>
														...
														<span data-credithrs="Credit Hrs">3</span>
														<div class="tg-description" data-coursetitle="Course Title">
													...
													<li>
														...
														<strong>15</strong>
														<div class="tg-description">
															<strong>Total Credit Hours of Semester 1</strong>
														</div>
													</li>
												</ul>
											</div>
											<h3 class="fa fa-angle-down">Semester 02</h3>
											<div class="tg-themecollapsecontent">
												<ul>
													<li>
														<strong>Sr#</strong>
