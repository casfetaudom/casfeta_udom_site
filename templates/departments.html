								...
								<div id="tg-navigation" class="collapse navbar-collapse tg-navigation">
									<ul>
										...
										<li class="menu-item-has-children current-menu-item">
											...
											<ul class="sub-menu">
												<li class="current-menu-item"><a href="departments.html">Departments</a></li>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<ol class="tg-breadcrumb">
							...
							<li class="tg-active">Departments</li>
						</ol>
					</div>
				</div>
			</div>
						...
						<div class="col-xs-12 col-sm-8 col-md-9 col-lg-9 pull-right">
							<div id="tg-content" class="tg-content">
								...
								<div id="tg-departmentscollapse" class="tg-themecollapse tg-departmentscollapse">
									...
									<h3 class="fa fa-angle-down">Faculty of Social Sciences</h3>
									<div class="tg-themecollapsecontent">
										<ul>
											<li>
												<span>1</span>
									...
									<h3 class="fa fa-angle-down">Faculty of Event Management</h3>
									<div class="tg-themecollapsecontent">
										<ul>
											<li>
												<span>1</span>
									...
									<h3 class="fa fa-angle-down">Faculty of Communication</h3>
									<div class="tg-themecollapsecontent">
										<ul>
											<li>
												<span>1</span>
