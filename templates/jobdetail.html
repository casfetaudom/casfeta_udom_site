											...
											<ul class="sub-menu">
												...
												<li class="menu-item-has-children current-menu-item">
													...
													<ul class="sub-menu">
														...
														<li class="current-menu-item"><a href="jobdetail.html">Job Detail</a></li>
													</ul>
												</li>
												<li class="menu-item-has-children">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<div id="tg-content" class="tg-content">
							<div class="tg-jobs tg-jobdetail">
								<span>Posted Date: June 27, 2017</span>
								<h1>Semi Commercial Sales Project, Institute of Home and Food Sciences</h1>
								...
								<div class="clearfix"></div>
								<h3>How To Apply?</h3>
								<p>Consectetur adipisicing elit, sed do eiusmod tempor incididunt labore dolore msagna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullaasmco laboris nisi uiat aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit etssse cillum dolore eu fugiat <a href="info%40uoek.html">info@uoek.com</a> or <a href="javascript:void(0);">call 111 222 333</a> nulla pariatur sintasr occaecat cupidatat proident, sunt in culpa qui officia deserunt mollit anim laborum unde omnis iste natus error sit voluptatem accusantium.</p>
							</div>
						</div>
					</div>
				</div>
